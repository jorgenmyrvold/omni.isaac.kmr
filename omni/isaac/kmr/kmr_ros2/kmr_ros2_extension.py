...
class KMRROS2Extension(BaseSampleExtension):
    ...
    #     # Used due to trouble with lambda functions in the dropdown_builder
    ...
    # def _on_set_configuration_button_event(self):
    #     self._sample._on_set_config_event(self.robot, self.environment)
    #     return
